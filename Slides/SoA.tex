...
\begin{frame}
    ...
    \end{tikzpicture}%, arrows={-Stealth[length=3pt]}
    }
    ...
    \point[\bfseries][2][Red]{Kernel :} {\def\c{Orange} \lbox{\c}{Matrice-Matrice} \lbox{\c}{Matrice-Vecteur} \lbox{\c}{Générique}}
    ...
    {\def\c{Purple}\hspace*{0.6cm} \lbox{\c}{Proche processeur} \lbox{\c}{Proche caches} \lbox{\c}{Esquive caches} \lbox{\c}{Proche mémoire principale}}
...
\begin{frame}
    ...
    \begin{minipage}[t]{0.44\linewidth}
        ...
        \point[\bfseries\color{Red}][0]{Accélérateur complet}
    ...
    \begin{minipage}[t]{0.54\linewidth}
        ...
        \vspace*{-7pt}
        \pause[1]%
        \includegraphics[width=\linewidth]{Figures/PDF/SoA_AnalysisForDesigners.pdf}

    \end{minipage}

    \vspace{0.2cm}
    \dref{ref:HiPEAC}{Valentin Isaac-{-}Chassande, Adrian Evans, Yves Durand, and Frédéric Rousseau. 2024. Dedicated Hardware Accelerators for Processing of Sparse Matrices and Vectors: A Survey. ACM Trans. Archit. Code Optim. 21, 2, Article 27 (June 2024), 26 pages.
    %
    \begin{tikzpicture}[remember picture, overlay]
        \node [shift={(-3.8cm, 2.75cm)}, rotate=0] at (current page.east)
            {%
                {\itshape\scriptsize Contribution \cref{ref:HiPEAC}}%
            };
    \end{tikzpicture}%
...
\begin{frame}
    ...
    \point[][2][Red]{Méthodes et choix de design \textbf{divers}}
    \arrow[]{\underbar{Comparaison de performance exhaustive difficile}}

    \smallskip

    \point[][2][white]{Ce qui resort :}
    \arrow[\bfseries][0][Red]{Pour les kernels Matrice-Matrice : \textcolor{Red}{Gustavson}}
    
    \subpt[][35][Red]{Réduction théorique du traffic par rapport à IP et OP} \cref{ref:HiPEAC}

    \smallskip

    \point[\color{white}][2]{Ce qui resort :}
