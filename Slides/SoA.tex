...
\begin{frame}
    ...
    \begin{minipage}[t]{0.30\linewidth}
        ...
        \pause[2]%
        \begin{tikzpicture}[remember picture, overlay]
            \node [shift={(2.4cm, -1.65cm)}, single arrow, draw=Red, very thick, fill=Red, opacity=0.3, minimum width = 1cm, single arrow head extend=3pt, minimum height=4.85cm, rotate=-90] at (current page.west)
                {}; % length of arrow
        \end{tikzpicture}%
        %
        \pause[3]%
