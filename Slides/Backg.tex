...
\begin{frame}
    Cache : mémoire intermédiaire entre le processeur et la mémoire principale -> prérequis

    Fonction : stocker quelques données proche du processeur -> prérequis

    Pourquoi : une transaction en mémoire principale prend du temps ($\sim$100 ns) -> prérequis
\end{frame}
